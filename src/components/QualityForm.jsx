...
const QualityForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://oee-backend-eta.vercel.app/api/quality-data', {
        method: 'POST',
        headers: {
  ...
  const handleCorrectionSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://oee-backend-eta.vercel.app/api/correction', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handlePlanSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://oee-backend-eta.vercel.app/api/set-plan', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
